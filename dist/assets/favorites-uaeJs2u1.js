import{l as i}from"./utils-7NcZ-LKH.js";i();const a=document.getElementById("favorites");let r=JSON.parse(localStorage.getItem("favorites"))||[];r.length===0?a.innerHTML="<p>No favorites yet 😔</p>":r.forEach(t=>{const e=document.createElement("div");e.classList.add("favorite-card"),e.innerHTML=`
